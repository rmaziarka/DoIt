...
IF "%2"=="" SET SCRIPTCOP_EXCLUDE="@('bat','_buildTools','dsc','externalLibs','teamcityProvisioning','examples')"
IF "%3"=="" SET SCRIPTCOP_PREREQ=%~dp0..\PSCI.classes.ps1,%~dp0..\core\utils\Write-ProgressExternal.ps1
)
